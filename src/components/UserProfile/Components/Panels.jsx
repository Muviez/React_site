    ...
    return (
        <TabContent className="tab-space tab-subcategories" activeTab={props.pageSub}>
            ...
            <TabPane tabId="ps3">
                ...
                Dynamically innovate resource-leveling customer service for state of the art customer service.
                Dynamically innovate resource-leveling customer service for state of the art customer service.
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Id, nemo repellendus! Excepturi perferendis reprehenderit culpa eius ab veniam repellat ipsum a, vero sunt, nemo necessitatibus numquam aliquid labore unde blanditiis tempora asperiores earum quo corrupti ut amet. Ipsa eligendi impedit animi corporis ipsam quas error eos. Nisi et commodi explicabo! Dolorem deleniti recusandae aliquid alias corporis aut fugiat at. Neque quos, distinctio, reiciendis cupiditate molestias culpa aspernatur sint odit vitae explicabo inventore voluptas laboriosam officia asperiores quae consequuntur corrupti dolor ipsa id libero repudiandae. Velit ab facilis nesciunt, sapiente numquam iure, aspernatur amet quas at fuga nulla nisi cum quam
